                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${option}')?'selected':''}}" ng-click="selectSpecification('${spec.attributeName}','${option}')">${option}<span title="点击取消选择">&nbsp;</span>
                                </a></dd>
                            </#list>
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                ...
                                <#list customAttributeItems as items>
                                <li>${items.text}：${items.value}</li>
                                </#list>
                            </ul>
